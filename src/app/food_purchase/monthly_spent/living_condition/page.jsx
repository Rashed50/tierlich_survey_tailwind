...
export default function SetNumberOfPet() {
    ...
    const handleSubmit = (e) => {
      ...
      router.push("/food_purchase/monthly_spent/family_status");
    ...
    return (
        <form onSubmit={handleSubmit} className="min-h-screen flex flex-col bg-[#f8f4ee] text-[#4A4A4A]">
         ...
         <div className="flex flex-col gap-4 items-center justify-center mt-10 px-4">
            ...
            {/* Footer */}
            <FooterComponent backHref="/food_purchase/monthly_spent" nextHref="/food_purchase/monthly_spent/family_status" isSubmit />
        </form>
    );
}
