    ...
    const handleSubmit = (e) => {
      ...
      //   }
       ...
       //  sessionStorage.setItem("number_of_pets", selected);
          ...
          //           
         router.push("/food_purchase/online/qs_what_do_you_feed/qs_what_donot_like_feed");
    ...
    return (
        <form onSubmit={handleSubmit} className="min-h-screen flex flex-col bg-[#f8f4ee] text-[#4A4A4A]">
         ...
         <div className="flex flex-col gap-4 items-center justify-center mt-10 px-4">
            ...
            {/* Footer */}
            <FooterComponent backHref="/food_purchase/qs_what_do_you_feed" nextHref="food_purchase/qs_what_do_you_feed/qs_what_donot_like_feed" isSubmit />
        </form>
    );
}
