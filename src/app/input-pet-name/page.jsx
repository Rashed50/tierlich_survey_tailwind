...
export default function SetNumberOfPet() {
    ...
    return (
        <form onSubmit={handleSubmit} className="min-h-screen flex flex-col bg-[#f8f4ee] text-[#4A4A4A]">
            <HeaderComponent progress={Math.floor(((currentPetIndex + 1) / Object.keys(petNames).length) * 100)} />
            ...
            <FooterComponent
                ...
                nextText={currentPetIndex < Object.keys(petNames).length - 1 ? "Next" : "Finish"}
            />
        </form>
    );
}